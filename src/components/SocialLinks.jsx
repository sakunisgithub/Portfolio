...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ananda-biswas-622172303/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@the.showstopper7",
    icon: Instagram,
    url: "https://www.instagram.com/the.showstopper7/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@sakunisgithub",
    icon: Github,
    url: "https://github.com/sakunisgithub",
    color: "#ffffff",
