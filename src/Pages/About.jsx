...
const AboutPage = () => {
  ...
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    ...
    const startDate = new Date("01-10-2021");
  ...
  const statsData = useMemo(() => [
    {
      ...
      description: "Insightful data solutions crafted",
    ...
    },
    {
      ...
      label: "Certificates",
      description: "Skills mastered and validated",
      animation: "fade-up",
    },
    {
      icon: Globe,
      ...
      label: "Years of Learning Statistics",
