...
const techStacks = [
  ...
  { icon: "Tidyverse.svg", language: "Tidyverse" },
  { icon: "Ggplot2.svg", language: "GGplot2" },
  { icon: "RStudio.svg", language: "R Studio"},
  ...
  { icon: "overleaf.svg", language: "LaTeX" },
  { icon: "Excel.svg", language: "Excel" },
  { icon: "Power_BI.svg", language: "Power BI" },
  { icon: "git-bash.svg", language: "Git" },
  { icon: "Github.svg", language: "GitHub" },
  { icon: "Jupyter.svg", language: "Jupyter" },
  { icon: "Google_Colaboratory.svg", language: "Google Colab" },
  { icon: "Visual_Studio_Code.svg", language: "VS Code"},
